...
bool GOUse_go_tutenkash_gong(Player* pPlayer, GameObject* pGo)
{
    ...
    if (!bWaveInMotion)
    {
        ...
        default:
            ...
            pTutenkash->GetMotionMaster(f)->MovePoint(0f, 2488.502686f, 801.684021f, 42.731823f);
            pTutenkash->GetMotionMaster(f)->MovePoint(0f, 2485.428955f, 815.734619f, 43.195621f);
            pTutenkash->GetMotionMaster(f)->MovePoint(0f, 2486.951904f, 826.718079f, 43.586765f);
            pTutenkash->GetMotionMaster(f)->MovePoint(0f, 2496.677002f, 838.880005f, 45.809792f);
            pTutenkash->GetMotionMaster(f)->MovePoint(0f, 2501.559814f, 847.080750f, 47.408485f);
            pTutenkash->GetMotionMaster(f)->MovePoint(0f, 2506.661377f, 855.430359f, 47.678036f);
            pTutenkash->GetMotionMaster(f)->MovePoint(0f, 2514.890869f, 861.339966f, 47.678036f);
            pTutenkash->GetMotionMaster(f)->MovePoint(0f, 2526.009033f, 865.386108f, 47.678036f);
            pTutenkash->GetMotionMaster(f)->MovePoint(0f, 2539.416504f, 874.278931f, 47.711197f);
