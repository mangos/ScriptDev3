...
struct ObjectDistanceOrder : public std::function<bool(const WorldObject, const WorldObject)>
{
...
struct ObjectDistanceOrderReversed : public std::function<bool(const WorldObject, const WorldObject)>
{
    const Unit* m_pSource;
